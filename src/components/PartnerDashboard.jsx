...
const PartnerDashboard = () => {
  ...
  if (!hasFeatureAccess(user?.subscription, 'whiteLabelApi')) {
    return (
      ...
      {activeTab === 'revenue' && dashboardData?.revenue && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-surface rounded-lg p-6 border border-border">
              <h3 className="font-medium text-text-primary mb-4">This Month</h3>
            ...
            <div className="bg-surface rounded-lg p-6 border border-border">
              <h3 className="font-medium text-text-primary mb-4">Last Month</h3>
              <p className="text-3xl font-bold text-text-primary">
                ${dashboardData.revenue.lastMonth.toFixed(2)}
              </p>
            </div>

            <div className="bg-surface rounded-lg p-6 border border-border">
              <h3 className="font-medium text-text-primary mb-4">Total Revenue</h3>
              <p className="text-3xl font-bold text-text-primary">
